...
<form id="contactform" class="rounded" action="modul/laptransumum/cetak.php" onsubmit="popup(this);" target="_blank" method="post" enctype="multipart/form-data">';
echo '<div id="papanpanel2">
	<h3>Cetak Data Transaksi Berdasarkan Tanggal</h3>
	</div>  ';
?>
