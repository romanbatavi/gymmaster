...
echo "<script>
function popup(form) {
    window.open('', 'konfirmasi', 'menubar=yes,scrollbars=yes,resizable=yes,width=800,height=400,top=50,left=200');
    form.target = 'konfirmasi';
}
</script>";
	echo'
	
	
<form id="contactform" class="rounded" action="modul/lapkonfirmasi/cetak.php" onsubmit="popup(this);" target="_blank" method="post" enctype="multipart/form-data">';
echo '<div id="papanpanel2">
	<h3>Cetak Data Konfirmasi Pembayaran Member</h3>
	</div>  ';
?>
